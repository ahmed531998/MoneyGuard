...
while(True):
    cmd = input("What do you want to do? Type help for the list of available commands, quit to exit: ").strip()
    if cmd == 'help':
        print('List of commands:\n',
              ...
              '- stream1: requires password. Given a data stream (simulated by a file), update classifier incrementally as instances arrive\n',
